...
// 一部の点に高さ(3つ目の値)を持たせている。
const WINDING_CONTROL_POINTS = [
  [0, -123.5], [66.5, -114], [104.5, -66.5, 18], [66.5, -38], [104.5, 9.5],
  [123.5, 66.5, 28], [66.5, 85.5], [19, 47.5], [19, 114], [-38, 123.5, 14],
  [-95, 85.5], [-57, 38], [-114, 9.5, 8], [-123.5, -47.5], [-66.5, -66.5],
  [-76, -114],
];
